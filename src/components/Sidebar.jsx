...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { path: '/tasks', icon: <Layers size={20} />, label: 'Projetos & Tarefas' }, // Módulo de Projetos
    { path: '/licenses', icon: <ShieldCheck size={20} />, label: 'Licenças Soft.' }, // Módulo de Licenças
    { path: '/services', icon: <Globe size={20} />, label: 'Contratos & Links' }, // Módulo de Contratos (Novo)
